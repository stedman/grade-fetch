// TODO: The much simpler `getScheduleData` module can replace this module for non-Elementary students.
//       So perhaps start there and then come here for Elementary student data.
//       We may also be able to assume that there will be 4 Marking Periods and
//       that sub-branching to harvest MP data is not needed.
...
const getCourseData = async (page) => {
  ...
  await page.goto(`${rootUrl}/ReportCards.aspx`, gotoOptions);
  ...
  /* SEE NOTE AT TOP OF PAGE FOR JUSTIFICATION OF COMMENTING THIS SECTION
