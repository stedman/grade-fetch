...
const utilities = {
   ...
   */
  // FIXME: mp||markingPeriod is confusing and needs to be resolved
  // ...we need to have the year included in some way, perhaps a new string: 2020-3 (schoolYear-markingPeriod)
  getMpIntervals: (mp = utilities.getMpForDate(), sy = utilities.getSchoolYear()) => {
    /**
